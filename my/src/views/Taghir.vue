<template>
 <section class="Edit Article">
    <div class="flex w-1440 h-16 bg-gry4 pt-2.5 pr-7 pb-2.5 pl-4">
        ...
        <button><router-link to="/about" class="mr-0 rounded border border-solid text-blue2 border-blue2 h-10 w-20">Logout</router-link></button>
    </div>
    <div class="flex">
        <div class="w-64 h-964 mr-8 mt-0 mb-0 ml-0 pt-3 pr-0 pb-817 pl-3 bg-blue">
            ...
            <button type="submit" class="w-24 h-5 text-gry2 text-lg mt-0 mr-32 mb-4 ml-3.5">All Articles</button>
            <button type="submit" class="w-24 h-5 text-gry2 text-lg mt-0 mr-32 mb-4 ml-3.5">New Article</button>
        </div>
        <div class="mt-6">
            <div class="text-black text-4xl">Edit Article</div>
            ...
            <br>
            <button @click="doedit" class="w-24 h-8 rounded border border-solid border-blue bg-blue mt-6 mr-770 mb-5 ml-1 pt-1 pr-7 pb-2 pl-6 text-gry2">Submit</button>
...
doedit(){
  axios.put('https://api.realworld.io/api/articles{slug}',{
    headers:{
